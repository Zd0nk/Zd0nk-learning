...
def main():
    ...
    # Try to load the dark wordmark (for header on dark bg)
    try:
        logo_b64 = _img_b64("datumly_logo_light.png")
    except Exception:
        try:
            logo_b64 = _img_b64("/mnt/user-data/uploads/datumly_logo_light.png")
        except Exception:
            logo_b64 = ""
